...
final class UserDataSyncService {
    ...
    func saveReminder(
        ...
        let document = ReminderDocument(
            ...
            takeNowWindowHours: max(takeNowWindowHours, 1),
            isEnabled: isEnabled,
    ...
    private func apply(
        ...
        for document in snapshot.reminders {
            ...
            let reminder = remindersById[document.id] ?? Reminder(
                ...
                takeNowWindowHours: document.takeNowWindowHours,
                medicine: medicine,
            ...
            reminder.takeNowWindowHours = max(document.takeNowWindowHours, 1)
